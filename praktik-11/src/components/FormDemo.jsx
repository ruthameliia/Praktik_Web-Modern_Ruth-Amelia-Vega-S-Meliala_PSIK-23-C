...
function FormDemo() {
  // 1. Inisialisasi state untuk Form Login
  ...
  // 2. Inisialisasi state untuk Form Profil (independen dari login)
        ...
        <form onSubmit={handleLoginSubmit}>
          ...
          <label>
            <input
              ...
              /* Menggunakan setValue manual karena Checkbox menggunakan 'checked', bukan 'value' */
